...
class CdnManager
{
    ...
    {
        $mode = $this->configuration()['mode'] ?? CdnMode::ORIGIN->value;
    ...
    public function configurationFromSetting(?SiteSetting $setting, array $overrides = []): array
    {
        ...
        return [
            ...
            'storage_access_key' => $this->normalizeString($overrides['cdn_storage_access_key'] ?? $setting?->cdn_storage_access_key ?? config('cdn.storage.access_key')),
            'storage_secret_key' => $this->normalizeString($overrides['cdn_storage_secret_key'] ?? $setting?->cdn_storage_secret_key ?? config('cdn.storage.secret_key')),
